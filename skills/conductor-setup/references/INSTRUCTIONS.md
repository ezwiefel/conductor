# Instructions for Conductor Setup
...
2.  **Select Code Style Guides:**
    -   List the available style guides by running `ls skills/conductor-setup/assets/code_styleguides/`.
    ...
    -   **Action:** Construct and execute a command to create the directory and copy all selected files. For example: `mkdir -p conductor/code_styleguides && cp skills/conductor-setup/assets/code_styleguides/python.md skills/conductor-setup/assets/code_styleguides/javascript.md conductor/code_styleguides/`
...
1.  **Copy Initial Workflow:**
    -   Copy `skills/conductor-setup/assets/workflow.md` to `conductor/workflow.md`.
